...
export function appendPromptHistoryEntry(history: string[], prompt: string): string[] {
...
export function removePromptHistoryEntry(history: string[], prompt: string): string[] {
	return history.filter((entry) => entry !== prompt);
}

export function appendPinnedPrompt(pinnedPrompts: string[], prompt: string): string[] {
	const trimmedPrompt = prompt.trim();
...
export function removePinnedPrompt(pinnedPrompts: string[], prompt: string): string[] {
